...
// const scroll = new LocomotiveScroll();
    ...
    return (
            ...
            <div data-scroll data-scroll-speed="-0.5" className='px-20 relative h-screen flex flex-col justify-center gap-0 overflow-x-hidden -translate-y-1/8'>
                ...
                <div className='absolute flex justify-between bottom-0 left-0 -translate-y-1/2 px-10 text-xl neue w-full border-t border-zinc-400 py-10  '>
